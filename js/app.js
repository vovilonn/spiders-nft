window.addEventListener("DOMContentLoaded", () => {
    ...
    if (pins) {
        document.addEventListener("click", function (e) {
            ...
            if (
                e.target === document.querySelector(".pin__phone") ||
                e.target === document.querySelector(".pin__web") ||
                e.target === document.querySelector(".pin__incub") ||
                e.target === document.querySelector(".pin__chips") ||
                e.target === document.querySelector(".pin__screen")
            ) {
                return;
            } else {
    ...
    introMusic.addEventListener("click", () => {
        ...
        audioMain.src = soundState ? dataMainAudio : "";
        introMusic.innerHTML = soundState
            ? `
    ...
    function mobileSlide() {
        ...
        if (currentSlide) {
            ...
            layers[index_currentSlide].firstChild.style.transform = `translate(${currentSlide.getAttribute(
                "data-position"
            )})`;
